return {
    ...
    commands = {
        ...
        screenshot = "scrot ~/Screenshots/$(date '+%Y-%m-%d-%H-%M-%S')-${HOST}.png && notify-send -t 1000 'Screenshot Taken'",
        screenshotSelect = "import ~/Screenshots/$(date '+%Y-%m-%d-%H-%M-%S')-${HOST}.png && notify-send -t 1000 'Screenshot Taken'",
